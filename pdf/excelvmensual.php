<?php session_start();
    ...
    getProperties()
        ...
        ->setTitle("Reporte mensual de ventas")
        ->setSubject("Reporte mensual")
        ->setDescription("Reporte mensual de ventas")
        ->setKeywords("GMZBol")
        ->setCategory("Reportes");
    $objPHPExcel->setActiveSheetIndex(0)->mergeCells('A1:G1');
    //$objSheet = $objPHPExcel->setActiveSheetIndex(0);
    $objSheet = $objPHPExcel->setActiveSheetIndex();
    $objSheet->setCellValue('A1', 'REPORTE MENSUAL DE VENTAS'." - ".$mes." de ".substr($fecha,0,4));
    ...
    header('Content-Disposition: attachment;filename="rmensual.xls"');
