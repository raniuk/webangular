...
class PDF extends FPDF {
    ...
    function Header(){
        ...
        $selectuven=$conn->query("SELECT numeropse FROM prestarserv WHERE idu='$user' AND idcli='$cliente' AND idpse='$idpse' LIMIT 1")->fetch();
        $correlativo = "";
...
$cliente = $_POST['rcli'];
$user = $_SESSION['iop'];
$selectuven=$conn->query("SELECT bancoempse, formapuse, detallefpuse, formapdse, detallefpdse, formaptse, detallefptse, formapcse, detallefpcse, tiempopse, lugarse, descuentopse, validezofertase FROM prestarserv WHERE idu='$user' AND idcli='$cliente' AND idpse='$idpse' LIMIT 1")->fetch();
...
$pdf->Row(array('Validez de la Oferta',$selectuven['validezofertase'].utf8_decode(' días y/o a confirmación de agenda.')));
$pdf->Output();
$conn = null;
