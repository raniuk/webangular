<div class="row">
  <div class="text-navy text-center"><h4>LISTA DE SERVICIO MENSUAL</h4></div>
  <div class="col-md-12">
    <div class="table-info">
      <div class="row">
        <div class="col-md-2">
          <div class="form-group">
            <form name="formlsm" action="../pdf/excelsmensual.php" method="POST" target="_blank">
              <p class="text-primary">Exportar:&nbsp;<button ng-click="prn_servm()" style="background: transparent; border: 0px; outline: none;" ng-disabled="actpdf"><img src="../public/img/excel.png" width="20px" height="20px" title="Excel"></button></p>
