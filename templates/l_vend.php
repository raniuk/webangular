<div class="row">
  <div class="text-navy text-center"><h4>LISTA DE VENTA DIARIA</h4></div>
  <div class="col-md-12">
    <div class="table-info">
      <div class="row">
        <div class="col-md-2">
          <div class="form-group">
            <form name="formlvd" action="../pdf/excelvdiaria.php" method="POST" target="_blank">
                <p class="text-primary">Exportar:&nbsp;<button ng-click="prn_ventad()" style="background: transparent; border: 0px; outline: none;" ng-disabled="actpdf"><img src="../public/img/excel.png" width="20px" height="20px" title="Excel"></button></p>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
          <thead class="bg-light-blue">
            <tr>
              ...
              <th>Nombre&nbsp;cliente&nbsp;&nbsp;<a class="btnsort" ng-click="sort_by('client');"><i class="glyphicon glyphicon-sort"></i></a></th>
              <th>Empresa&nbsp;&nbsp;<a class="btnsort" ng-click="sort_by('razon');"><i class="glyphicon glyphicon-sort"></i></a></th>
              <th>Forma&nbsp;pago&nbsp;&nbsp;<a class="btnsort" ng-click="sort_by('forma');"><i class="glyphicon glyphicon-sort"></i></a></th>
              <th>Tiempo&nbsp;entrega&nbsp;&nbsp;<a class="btnsort" ng-click="sort_by('tiempo');"><i class="glyphicon glyphicon-sort"></i></a></th>
              <th>Acciones</th>
            </tr>
          </thead>
          <tbody>
    ...
    <div class="modal-content">
      ...
      <form name="fvent" action="../pdf/vfactura.php" method="POST" target="_blank">
        <div class="modal-body text-center">
          <h5>Desea ver la formulario en PDF?</h5>
        </div>
